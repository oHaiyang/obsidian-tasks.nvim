...
local board_edit_form_win = vim.api.nvim_get_current_win()
local board_edit_form_win_config = vim.api.nvim_win_get_config(board_edit_form_win)
assert(board_edit_form_win_config.relative == "editor", "board edit form should open in a centered floating window")
assert(board_edit_form_win_config.border ~= nil, "board edit form float should have a border")
...
assert(not vim.api.nvim_win_is_valid(board_edit_form_win), "successful board-origin save_form should close the form window")
